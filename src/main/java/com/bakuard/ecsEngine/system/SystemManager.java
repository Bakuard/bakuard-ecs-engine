 ...
 * не имеет никакой функциональности игрового цикла. Вместо этого, он решает две другие задачи:
 * <ol>
 *    <li>Хранит и предоставляет доступ ко всем системам используемым в игре. </li>
 *    <li>Позволяет сгруппировать системы. Группа систем - это всего лишь обычный список, которому
